           ...
           AOC Life Roleplay
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2" href="../pages/dashboard.php">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              ...
              <div class="card card-plain">
                <div class="card-header">
                  ...
                  <p class="mb-0">Please click Sign Up below to continue to Steam's Website. </p>
                </div>
                <div class="card-body">
                  <form role="form">
                
                  <a 
href="https://steamcommunity.com/openid/login?openid.claimed_id=http://specs.openid.net/auth/2.0/identifier_select&openid.identity=http://specs.openid.net/auth/2.0/identifier_select&openid.mode=checkid_setup&openid.ns=http://specs.openid.net/auth/2.0&openid.realm=https://cad.ageofcivilization.xyz&openid.return_to=https://cad.ageofcivilization.xyz/aoccad/pages/steamresponse.php"
target="_blank"
rel="noreferrer noopener"
class="link-light"
>    
<button type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">  Continue to Steam Sign-In        </button>
</a>
